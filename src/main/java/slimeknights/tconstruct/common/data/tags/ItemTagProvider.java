...
public class ItemTagProvider extends ItemTagsProvider {
  ...
  private void addCommon() {
    ...
    // glass
    // NeoForge renamed GLASS_SILICA/GLASS_TINTED to GLASS_BLOCKS_CHEAP/GLASS_BLOCKS_TINTED; the old blanket
    // STAINED_GLASS/STAINED_GLASS_PANES tags have no replacement, superseded by the per-color loop below plus
    // the GLASS_BLOCKS/GLASS_PANES umbrella tags already copied for GLASS_BLOCKS_COLORLESS above
