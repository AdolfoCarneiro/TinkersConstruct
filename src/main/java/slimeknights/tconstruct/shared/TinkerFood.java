...
public final class TinkerFood {
  ...
  public static final FoodProperties EARTH_CAKE = new FoodProperties.Builder().nutrition(1).saturationMod(0.3f).alwaysEat().effect(() -> new MobEffectInstance(TinkerEffects.bouncy,      30 * 20, 0), 1.0f).build();
  public static final FoodProperties SKY_CAKE   = new FoodProperties.Builder().nutrition(1).saturationMod(0.2f).alwaysEat().effect(() -> new MobEffectInstance(TinkerEffects.doubleJump,  30 * 20, 0), 1.0f).build();
  public static final FoodProperties ICHOR_CAKE = new FoodProperties.Builder().nutrition(1).saturationMod(0.3f).alwaysEat().effect(() -> new MobEffectInstance(TinkerEffects.antigravity, 30 * 20, 0), 1.0f).build();
  public static final FoodProperties ENDER_CAKE = new FoodProperties.Builder().nutrition(1).saturationMod(0.4f).alwaysEat().effect(() -> new MobEffectInstance(TinkerEffects.returning,   30 * 20, 0), 1.0f).fast().build();
  ...
  public static final FoodProperties EARTH_BOTTLE = new FoodProperties.Builder().alwaysEat().effect(() -> new MobEffectInstance(TinkerEffects.experienced,  120 * 20, 0), 1.0f).effect(() -> new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 120 * 20, 1), 1.0f).build();
  public static final FoodProperties SKY_BOTTLE   = new FoodProperties.Builder().alwaysEat().effect(() -> new MobEffectInstance(TinkerEffects.ricochet,     120 * 20, 0), 1.0f).effect(() -> new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 120 * 20, 1), 1.0f).build();
  ...
  public static final FoodProperties ENDER_BOTTLE = new FoodProperties.Builder().alwaysEat().effect(() -> new MobEffectInstance(TinkerEffects.enderference,  60 * 20, 0), 1.0f).effect(() -> new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN,  60 * 20, 1), 1.0f).build();
