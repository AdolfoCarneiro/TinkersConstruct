...
public final class TinkerFood {
  ...
  public static final FoodProperties EARTH_BOTTLE = new FoodProperties.Builder().alwaysEdible().effect(() -> new MobEffectInstance(TinkerEffects.experienced,  120 * 20, 0), 1.0f).effect(() -> new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 120 * 20, 1), 1.0f).build();
  public static final FoodProperties SKY_BOTTLE   = new FoodProperties.Builder().alwaysEdible().effect(() -> new MobEffectInstance(TinkerEffects.ricochet,     120 * 20, 0), 1.0f).effect(() -> new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 120 * 20, 1), 1.0f).build();
  ...
  public static final FoodProperties ENDER_BOTTLE = new FoodProperties.Builder().alwaysEdible().effect(() -> new MobEffectInstance(TinkerEffects.enderference,  60 * 20, 0), 1.0f).effect(() -> new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN,  60 * 20, 1), 1.0f).build();
