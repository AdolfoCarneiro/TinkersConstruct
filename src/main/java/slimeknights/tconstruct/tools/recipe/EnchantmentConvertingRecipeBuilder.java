...
public class EnchantmentConvertingRecipeBuilder extends AbstractSizedIngredientRecipeBuilder<EnchantmentConvertingRecipeBuilder> {
  ...
  public EnchantmentConvertingRecipeBuilder modifierPredicate(IJsonPredicate<ModifierId> modifierPredicate) {
  ...
  public void save(RecipeOutput consumer, ResourceLocation id) {
    ...
    consumer.accept(id, new EnchantmentConvertingRecipe(name, inputs, matchBook, returnInput, modifierPredicate), advancementId);
  }
}
