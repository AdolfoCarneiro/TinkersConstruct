...
public enum ZoomModule implements ModifierModule, GeneralInteractionModifierHook, KeybindInteractModifierHook, UsingToolModifierHook, EquipmentChangeModifierHook {
  ...
  /** Stops zooming */
  private static void stopZoom(ModifierEntry modifier, TinkerDataCapability.Holder data) {
    data.computeIfAbsent(TinkerDataKeys.FOV_MODIFIER).remove(modifier.getId());
  }
