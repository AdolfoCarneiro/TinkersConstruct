...
public class SmelteryRecipeProvider extends BaseRecipeProvider implements ISmelteryRecipeHelper, ICommonRecipeHelper {
  ...
  private void addSmelteryRecipes(RecipeOutput output) {
    ...
    // cobble
    searedCasting(output, TinkerSmeltery.searedCobble, CompoundIngredient.of(Ingredient.of(Tags.Items.COBBLESTONES), Ingredient.of(Blocks.GRAVEL)), castingFolder + "cobble/block");
    ...
    // stone
    searedCasting(output, TinkerSmeltery.searedStone, Ingredient.of(Tags.Items.STONES), castingFolder + "stone/block_from_clay");
  ...
  private void addMeltingRecipes(RecipeOutput output) {
    ...
    MeltingRecipeBuilder.melting(Ingredient.of(Tags.Items.GLASS_BLOCKS_CHEAP), TinkerFluids.moltenGlass, FluidValues.GLASS_BLOCK, 1.0f)
                        .save(output, location(folder + "glass/block"));
