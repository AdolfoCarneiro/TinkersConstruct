...
public class BlockModelSkullRenderer extends SkullModelBase {
  ...
  public void renderToBuffer(PoseStack poseStack, VertexConsumer buffer, int light, int overlay, int color) {
    ...
    if (color != -1) {
      buffer = new TintedVertexBuilder(buffer, FastColor.ARGB32.red(color), FastColor.ARGB32.green(color), FastColor.ARGB32.blue(color), FastColor.ARGB32.alpha(color));
    }
