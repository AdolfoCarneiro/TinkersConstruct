...
public interface HarvestEnchantmentsModifierHook {
   ...
   * @see EnchantmentModifierHook#addEnchantment(ItemEnchantments.Mutable, net.minecraft.core.Holder, int)
   * @see EnchantmentModifierHook.SingleHarvestEnchantment
   */
  void updateHarvestEnchantments(IToolStackView tool, ModifierEntry modifier, ToolHarvestContext context, EquipmentContext equipment, EquipmentSlot slot, ItemEnchantments.Mutable map);
   ...
   * @return  Old enchantments if enchants were applied, null otherwise
   */
  @Nullable
  static ItemEnchantments updateHarvestEnchantments(IToolStackView tool, ItemStack stack, ToolHarvestContext context) {
    ...
    if (player == null || !player.isCreative()) {
      ...
      ItemEnchantments.Mutable enchantments = null;
          ...
          for (ModifierEntry entry : armor.getModifierList()) {
            ...
            if (hook != null) {
              ...
              if (enchantments == null) {
                ...
                enchantments = new ItemEnchantments.Mutable(originalEnchants);
              }
   ...
   * @param originalEnchants Original enchantments component to restore
   */
  static void restoreEnchantments(ItemStack stack, ItemEnchantments originalEnchants) {
    EnchantmentHelper.setEnchantments(stack, originalEnchants);
  }
  ...
  record AllMerger(Collection<HarvestEnchantmentsModifierHook> modules) implements HarvestEnchantmentsModifierHook {
    @Override
    public void updateHarvestEnchantments(IToolStackView tool, ModifierEntry modifier, ToolHarvestContext context, EquipmentContext equipment, EquipmentSlot slot, ItemEnchantments.Mutable map) {
