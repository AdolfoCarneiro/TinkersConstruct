...
public class MaterialMeltingRecipe implements IMeltingRecipe, IMultiRecipe<MeltingRecipe> {
  ...
  /** @deprecated use {@link #MaterialMeltingRecipe(MaterialVariantId,int,FluidOutput,List)} */
      ...
      if (input.get().isHidden()) {
        ...
        multiRecipes = MaterialCastingLookup
          ...
          .map(entry -> {
            ...
            return new MeltingRecipe("", MaterialIngredient.of(entry.getKey(), inputId).toVanilla(), output, temperature,
