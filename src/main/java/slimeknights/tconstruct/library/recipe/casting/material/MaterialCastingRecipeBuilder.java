...
public class MaterialCastingRecipeBuilder extends AbstractRecipeBuilder<MaterialCastingRecipeBuilder> {
  ...
  public void save(RecipeOutput output, ResourceLocation id) {
    ...
    if (result != null) {
      output.accept(id, new MaterialCastingRecipe(recipeSerializer, group, cast, itemCost, result, allowedMaterials, castPurpose != CastPurpose.CATALYST, switchSlots), advancementHolder);
    } else if (resultTool != null) {
      output.accept(id, new ToolCastingRecipe(recipeSerializer, group, cast, itemCost, castPurpose, resultTool, allowedMaterials, extraMaterials), advancementHolder);
    } else {
