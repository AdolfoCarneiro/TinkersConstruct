...
public class MultilevelIncrementalModifierRecipeBuilder extends AbstractMultilevelModifierRecipeBuilder<MultilevelIncrementalModifierRecipeBuilder> {
  ...
  public void save(RecipeOutput output, ResourceLocation id) {
    ...
    AdvancementHolder advancementHolder = buildOptionalAdvancement(output, id, "modifiers");
    output.accept(id, new MultilevelIncrementalModifierRecipe(input, amountPerItem, neededPerLevel, tools, maxToolSize, result, leftover, allowCrystal, levels, checkTraitLevel), advancementHolder);
  }
}
