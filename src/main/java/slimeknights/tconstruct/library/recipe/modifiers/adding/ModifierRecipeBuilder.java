...
public class ModifierRecipeBuilder extends AbstractModifierRecipeBuilder<ModifierRecipeBuilder> {
  ...
  public void save(RecipeOutput output, ResourceLocation id) {
    ...
    output.accept(id, new ModifierRecipe(inputs, tools, maxToolSize, result, ModifierEntry.VALID_LEVEL.range(minLevel, maxLevel), slots, allowCrystal, checkTraitLevel), advancementId);
  }
}
