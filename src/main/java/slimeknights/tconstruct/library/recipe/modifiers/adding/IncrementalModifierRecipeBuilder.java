...
public class IncrementalModifierRecipeBuilder extends AbstractModifierRecipeBuilder<IncrementalModifierRecipeBuilder> {
  ...
  public void save(RecipeOutput output, ResourceLocation id) {
    ...
    output.accept(id, new IncrementalModifierRecipe(input, amountPerItem, neededPerLevel, tools, maxToolSize, result, ModifierEntry.VALID_LEVEL.range(minLevel, maxLevel), slots, leftover, allowCrystal, checkTraitLevel), advancementId);
  }
}
