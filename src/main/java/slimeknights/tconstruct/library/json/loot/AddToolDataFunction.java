...
public class AddToolDataFunction extends LootItemConditionalFunction {
  ...
  public static final MapCodec<AddToolDataFunction> SERIALIZER = RecordCodecBuilder.mapCodec(instance ->
    commonFields(instance).and(instance.group(
      Codec.FLOAT.optionalFieldOf("damage_percent", 0f).forGetter(function -> function.damage),
      RandomMaterial.LOADER.mapCodec(TypedMap.EMPTY).codec().listOf().optionalFieldOf("materials", List.of()).forGetter(function -> function.materials))
