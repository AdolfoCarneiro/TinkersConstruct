...
// LootingLevelEvent removed in NeoForge 1.21.1 — looting handled via LootContext params
...
public class ModifierLootingHandler {
  ...
  public static void init() {
    ...
    // TODO 1.21: LootingLevelEvent removed — looting hook disabled until replacement found
  ...
  private static void onLooting(net.neoforged.bus.api.Event event) {
    // LootingLevelEvent was removed from NeoForge 1.21.1
    // Looting is now handled differently via LootContext
  }
