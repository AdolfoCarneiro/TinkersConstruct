...
public final class ToolBuildHandler {
  ...
  public static ItemStack buildToolForRendering(Item item, ToolDefinition definition) {
    ...
    CompoundTag _tag = stack.getOrDefault(DataComponents.CUSTOM_DATA, CustomData.EMPTY).copyTag(); _tag.putBoolean(TooltipUtil.KEY_DISPLAY, true); stack.set(DataComponents.CUSTOM_DATA, CustomData.of(_tag));
    return stack;
  }
  ...
  public static ItemStack getDisplayPart(IToolPart toolPart, int i) {
    ...
    CompoundTag _tag2 = item.getOrDefault(DataComponents.CUSTOM_DATA, CustomData.EMPTY).copyTag(); _tag2.putBoolean(TooltipUtil.KEY_DISPLAY, true); item.set(DataComponents.CUSTOM_DATA, CustomData.of(_tag2));
    return item;
  }
