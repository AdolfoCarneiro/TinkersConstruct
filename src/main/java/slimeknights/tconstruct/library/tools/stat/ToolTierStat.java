...
public class ToolTierStat implements IToolStat<Tier> {
  ...
  public Tag write(Tier value) {
    ResourceLocation id = HarvestTiers.getTierName(value);
    if (id != null) {
  ...
  public JsonElement serialize(Tier value) {
    return new JsonPrimitive(Objects.requireNonNull(HarvestTiers.getTierName(value)).toString());
  }
  ...
  public void toNetwork(RegistryFriendlyByteBuf buffer, Tier value) {
    buffer.writeResourceLocation(Objects.requireNonNull(HarvestTiers.getTierName(value)));
  }
