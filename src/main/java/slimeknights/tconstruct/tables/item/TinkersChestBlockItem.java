...
/**
 * Dyeable chest block. {@code DyeableLeatherItem} was removed in 1.21.1 in favor of the
 * {@code DataComponents.DYED_COLOR}/{@code DyedItemColor} component pattern (see {@code TableClientEvents}
 * item color handler for the render-side counterpart of this same lookup).
 */
